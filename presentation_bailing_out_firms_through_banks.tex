...
Calomiris and Kahn (1991), Diamond and Rajan (2002), Gorton and Huang (2004), Faccio et al. (2006), Ennis and Keister (2009), Blau et al. (2013), Acharya et al. (2014), Lewrick et al. (2014) \\
\vspace{0.5cm}
\textbf{\large\underline{Corporate liquidity:}}\\
Holström and Tirole (1997), Tirole (2006), Yun (2009), Jimenez et al. (2009), Campello et al. (2011),  Demiroglu and James (2011)\\
\vspace{0.5cm}
...
Model of government bailout of firms through financial intermediaries
	\begin{itemize}[label={\MyBall}]
		...
		\pause
		\item Due to moral hazard between the government and the firm, the fiscal cost of injecting liquidity exhibits a discontinuity.
		\pause
